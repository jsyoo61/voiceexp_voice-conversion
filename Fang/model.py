...
class CycleGAN(object):
    ...
    def __init__(self, num_features, discriminator = discriminator, generator = generator, mode = 'train', log_dir = '.\\log'):
    ...
    def train(self, input_A, input_B, lambda_cycle, generator_learning_rate, discriminator_learning_rate):
        ...
        generation_A, generation_B, generator_loss, _, generator_summaries = self.sess.run(
            ...
            feed_dict = {self.lambda_cycle: lambda_cycle, self.input_A_real: input_A, self.input_B_real: input_B, self.generator_learning_rate: generator_learning_rate})
